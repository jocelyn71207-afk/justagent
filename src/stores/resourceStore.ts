...
export const useResourceStore = defineStore('resource', () => {
  const resourceList = ref<ResourceFile[]>([
    ...
    { showMoreOption: false, id: 'res3',  version: 1, fileName: 'Teva2025商品總表.xlsx',       fileUrl: '',                                         fileType: 'EXCEL', processType: 'AI_PARSED', status: 'stored',  creatorType: 'USER', ownerId: 'user1',    ownerName: 'Lucas',    lastModify: '2026-02-06 14:15:00' },
